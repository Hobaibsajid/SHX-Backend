...
export interface ApiCoachCoach extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    coachStatus: Schema.Attribute.Enumeration<
...
export interface ApiMatchMatch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::match.match'> &
      Schema.Attribute.Private;
    matchtime: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    team_1: Schema.Attribute.Relation<'manyToOne', 'api::team.team'>;
    team_2: Schema.Attribute.Relation<'manyToOne', 'api::team.team'>;
    team1_Score: Schema.Attribute.Integer;
    team2_Score: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPlayerPlayer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    playerNumber: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    rejectedTeams: Schema.Attribute.Relation<'manyToMany', 'api::team.team'>;
    RequestedTeam: Schema.Attribute.Relation<'manyToOne', 'api::team.team'>;
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    coachid: Schema.Attribute.Relation<'manyToOne', 'api::coach.coach'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::team.team'> &
      Schema.Attribute.Private;
    matchesAsTeam1: Schema.Attribute.Relation<'oneToMany', 'api::match.match'>;
    matchesAsTeam2: Schema.Attribute.Relation<'oneToMany', 'api::match.match'>;
    playerRequests: Schema.Attribute.Relation<
      'oneToMany',
      'api::player.player'
    >;
    players: Schema.Attribute.Relation<'manyToMany', 'api::player.player'>;
    publishedAt: Schema.Attribute.DateTime;
    rejectedPlayerRequests: Schema.Attribute.Relation<
      'manyToMany',
      'api::player.player'
    >;
    sport: Schema.Attribute.String;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    coachId: Schema.Attribute.Relation<'oneToOne', 'api::coach.coach'>;
    ...
    playerId: Schema.Attribute.Relation<'oneToOne', 'api::player.player'>;
